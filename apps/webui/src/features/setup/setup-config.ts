...
type SetupSettings = UpdateRuntimeSettingsRequest["settings"];
...
export function validateSetupConfigFields(
    setupConfigFields: Element | null,
...
export function renderSetupConfigFields(
    setupConfigFields: HTMLElement | null,
    fields: ConfigFieldDescriptor[],
): void {
...
export function collectSetupSettings(
    setupConfigFields: Element | null,
    configSchema: ConfigFieldDescriptor[],
): SetupSettings {
...
function groupConfigFields(fields: ConfigFieldDescriptor[]): ConfigSection[] {
