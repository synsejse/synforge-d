...
#[openapi(
    ...
    paths(
        ...
        logs::get_job_log_meta_by_source,
        logs::get_job_log_chunk_by_source,
    ...
    components(
        schemas(
            ...
            synforge_core::api::LogChunkQuery,
    ...
    tags(
        ...
        (name = "Logs", description = "Per-job log source discovery and chunked retrieval"),
