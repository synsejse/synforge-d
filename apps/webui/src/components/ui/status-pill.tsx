...
export default function StatusPill({ status }: Props) {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 border px-2 py-[5px] font-mono text-xs font-semibold uppercase leading-none tracking-[0.1em] ${classes[status] || "border-edge-strong bg-black text-strong"}`}>
