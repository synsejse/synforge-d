...
#[openapi(
    ...
    paths(
        ...
        api::jobs::delete_job,
        api::jobs::prune_failed_jobs,
        api::logs::get_job_log_manifest,
        api::logs::get_job_log_meta_by_source,
        api::logs::get_job_log_chunk_by_source,
        api::artifacts::download_job_artifact,
