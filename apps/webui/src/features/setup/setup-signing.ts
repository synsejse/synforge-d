type SetupSigningControllerOptions = {
    toggleButton: HTMLElement | null;
    stateNote: HTMLElement | null;
    generateButton: HTMLElement | null;
    importButton: HTMLElement | null;
    importFileInput: HTMLElement | null;
    keyNote: HTMLElement | null;
    clearSetupError: () => void;
    setSetupError: (message: string) => void;
};

type SetupSigningPayload = {
    enableSigning: boolean;
    signingArmoredPrivateKey: string | null;
};

export type SetupSigningController = {
    reset: () => void;
    validate: () => string | null;
    payload: () => SetupSigningPayload;
};
...
export function createSetupSigningController({
    ...
    clearSetupError,
    setSetupError,
}: SetupSigningControllerOptions): SetupSigningController {
    let enabled = true;
    let mode = "generate";
