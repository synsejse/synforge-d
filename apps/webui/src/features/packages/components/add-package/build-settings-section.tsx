        ...
        <div className="border border-edge bg-surface-alt p-4 lg:col-span-2">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <button
              ...
              className="border border-edge bg-black px-4 py-2 font-mono text-xs font-bold uppercase tracking-[0.15em] text-muted transition duration-100 ease-linear hover:border-white hover:bg-surface-alt"
            >
              Choose chroots
            </button>
          </div>
